...
Decoherence does not place a fundamental limit on the accuracy of PE.   Bayesian inference to can be used to learn $\phi$ to an arbitrary number of digits using $M \approx T_2$ for certain noise models~\cite{granade_robust_2012}.  
