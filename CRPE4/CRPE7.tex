...
affords an efficient inference process for these bits.
...
distribution~\cite{granade_robust_2012,ferrie_high_2014}. These estimates of
the uncertainty are crucial for us because they can be used to design highly informative experiments for
finding the true eigenvalue and allow the protocol to be terminated when a fixed accuracy has been reached.
...
regime and IPE becomes increasingly impractical in lieu of fault-tolerance.  Finally, the ability of our algorithm to learn in the presence of decoherence provides an efficient alternative to the
...
and our work shows that modern ideas from machine learning can be used therein to great effect.  
