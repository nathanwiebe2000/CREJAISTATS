...
As an alternative to particle filtering, rejection sampling can also
be used to perform Bayesian inference. In particular, to draw a sample
from a posterior distribution, begin by drawing a sample from $P(x)$.
Then, reject that sample with
