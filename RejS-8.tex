...
RF algorithm is given in~\autoref{supp-alg:batchcrej} (Supplemental Material).
...
We further elaborate in \autoref{supp-app:sensitivity-kappa} with a numerical example.
