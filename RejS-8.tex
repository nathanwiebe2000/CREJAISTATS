...
This probability
can be increased by instead rejecting a sample with probability $P(x|E)/\kappa_E$ where
...
It does however make the probability of acceptance $\sum_x P(E|x) P(x)/\kappa_E = P(E) / \kappa_E$, which
