...
time dependent parameters in online settings, and its performance on MNIST classification problems.
\end{abstract}
...
We see that taking $\kappa_E\gtrsim 2/3$ does not prevent the algorithm from learning, although it certainly does
...
\begin{figure}
    \begin{center}
        \includegraphics[width=0.8\textwidth]{kappa_E-failure-crop.pdf}
    \end{center}
    \caption{\label{fig:sensitivity-kappa}
        ...
        loss
        before performing any rejection filtering updates). Note that the
