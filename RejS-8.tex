...
In this work, we have introduced a new method, particle filtering, that integrates
rejection sampling with particle filtering. Our method retains many of the benefits
of each, while using substantially less memory than conventional methods for Bayesian inference.
In particular, our method only requires remembering a single sample at a time, making it ideal
