...
filtering.
\textbf{KMS: Then elaborate on this case and why it is compelling
to use your approach over other existing approaches.  Worth citing a few of
the competing approaches for the active learning domain here.}
