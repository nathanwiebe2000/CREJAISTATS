...
by combining rejection sampling with particle filtering to estimate the first two moments of the posterior distribution.
...
This allows rejection filtering to estimate the first two moments of the posterior distribution while storing no more
