...
distribution and we dub this process resampling because of its similarity to resampling in sequential Monte Carlo methods~\cite{doucet2000sequential,del2012adaptive,van2000unscented,liu2001combined}.
...
In Apx G, we give a version of our algorithm that treads width for depth by batching the data.
